...
_lr_productions = [
  ...
  ('program_content -> function_dec program_content','program_content',2,'p_program_content','150050076-150050096.py',396),
  ('program_content -> function_body program_content','program_content',2,'p_program_content','150050076-150050096.py',397),
  ('program_content -> program program_content','program_content',2,'p_program_content','150050076-150050096.py',398),
  ('program_content -> function_dec','program_content',1,'p_program_content2','150050076-150050096.py',404),
  ('program_content -> function_body','program_content',1,'p_program_content2','150050076-150050096.py',405),
  ('program_content -> program','program_content',1,'p_program_content2','150050076-150050096.py',406),
  ('program_content -> declaration','program_content',1,'p_program_content3','150050076-150050096.py',413),
  ('program_content -> declaration program_content','program_content',2,'p_program_content4','150050076-150050096.py',425),
  ('function_dec -> datatype pointer LPAREN arguments RPAREN SEMICOLON','function_dec',6,'p_function_dec','150050076-150050096.py',438),
  ('function_dec -> datatype namevar LPAREN arguments RPAREN SEMICOLON','function_dec',6,'p_function_dec','150050076-150050096.py',439),
  ('function_dec -> datatype pointer LPAREN RPAREN SEMICOLON','function_dec',5,'p_function_dec2','150050076-150050096.py',444),
  ('function_dec -> datatype namevar LPAREN RPAREN SEMICOLON','function_dec',5,'p_function_dec2','150050076-150050096.py',445),
  ('arguments -> datatype pointer','arguments',2,'p_arguments','150050076-150050096.py',451),
  ('arguments -> datatype namevar','arguments',2,'p_arguments','150050076-150050096.py',452),
  ('arguments -> datatype pointer COMMA arguments','arguments',4,'p_arguments','150050076-150050096.py',453),
  ('arguments -> datatype namevar COMMA arguments','arguments',4,'p_arguments','150050076-150050096.py',454),
  ('function_body -> datatype pointer LPAREN arguments RPAREN LBRACE function_content return_stat RBRACE','function_body',9,'p_function_body','150050076-150050096.py',459),
  ('function_body -> datatype namevar LPAREN arguments RPAREN LBRACE function_content return_stat RBRACE','function_body',9,'p_function_body','150050076-150050096.py',460),
  ('function_body -> datatype pointer LPAREN RPAREN LBRACE function_content return_stat RBRACE','function_body',8,'p_function_body2','150050076-150050096.py',485),
  ('function_body -> datatype namevar LPAREN RPAREN LBRACE function_content return_stat RBRACE','function_body',8,'p_function_body2','150050076-150050096.py',486),
  ('return_stat -> RETURN pointer SEMICOLON','return_stat',3,'p_return','150050076-150050096.py',513),
  ('return_stat -> RETURN NAME SEMICOLON','return_stat',3,'p_return','150050076-150050096.py',514),
  ('return_stat -> RETURN SEMICOLON','return_stat',2,'p_return','150050076-150050096.py',515),
  ('function_call -> NAME LPAREN varlist RPAREN SEMICOLON','function_call',5,'p_func_call','150050076-150050096.py',520),
  ('function_call -> NAME LPAREN RPAREN SEMICOLON','function_call',4,'p_func_call','150050076-150050096.py',521),
  ('program -> VOID MAIN LPAREN RPAREN LBRACE function_content RBRACE','program',7,'p_program','150050076-150050096.py',528),
  ('function_content -> assignment_statement','function_content',1,'p_function_content','150050076-150050096.py',563),
  ('function_content -> while_stat','function_content',1,'p_function_content','150050076-150050096.py',564),
  ('function_content -> if_stat','function_content',1,'p_function_content','150050076-150050096.py',565),
  ('function_content -> function_call','function_content',1,'p_function_content','150050076-150050096.py',566),
  ('function_content -> assignment_statement function_content','function_content',2,'p_function_content2','150050076-150050096.py',576),
  ('function_content -> while_stat function_content','function_content',2,'p_function_content2','150050076-150050096.py',577),
  ('function_content -> if_stat function_content','function_content',2,'p_function_content2','150050076-150050096.py',578),
  ('function_content -> function_call function_content','function_content',2,'p_function_content2','150050076-150050096.py',579),
  ('function_content -> declaration','function_content',1,'p_function_content3','150050076-150050096.py',591),
  ('function_content -> declaration function_content','function_content',2,'p_function_content4','150050076-150050096.py',603),
  ('declaration -> datatype varlist SEMICOLON','declaration',3,'p_declaration','150050076-150050096.py',616),
  ('datatype -> INT','datatype',1,'p_datatype','150050076-150050096.py',632),
  ('datatype -> FLOAT','datatype',1,'p_datatype','150050076-150050096.py',633),
  ('datatype -> VOID','datatype',1,'p_datatype','150050076-150050096.py',634),
  ('namevar -> NAME','namevar',1,'p_namevar','150050076-150050096.py',640),
  ('varlist -> namevar COMMA varlist','varlist',3,'p_varlist1','150050076-150050096.py',647),
  ('varlist -> pointer COMMA varlist','varlist',3,'p_varlist1','150050076-150050096.py',648),
  ('varlist -> namevar','varlist',1,'p_varlist2','150050076-150050096.py',656),
  ('varlist -> pointer','varlist',1,'p_varlist2','150050076-150050096.py',657),
  ('pointer -> ASTERISK pointer','pointer',2,'p_pointer','150050076-150050096.py',665),
  ('pointer -> ASTERISK namevar','pointer',2,'p_pointer','150050076-150050096.py',666),
  ('assignment_statement -> ID EQUAL RIGHT SEMICOLON','assignment_statement',4,'p_assignment_statement','150050076-150050096.py',673),
  ('assignment_statement -> LEFT EQUAL expression SEMICOLON','assignment_statement',4,'p_assignment_statement','150050076-150050096.py',674),
  ('assignment_statement -> ID EQUAL function_call','assignment_statement',3,'p_assignment_statement','150050076-150050096.py',675),
  ('assignment_statement -> LEFT EQUAL function_call','assignment_statement',3,'p_assignment_statement','150050076-150050096.py',676),
  ('ID -> NAME','ID',1,'p_id','150050076-150050096.py',687),
  ('LEFT -> ASTERISK var','LEFT',2,'p_left','150050076-150050096.py',695),
  ('RIGHT -> AMPERSAND var','RIGHT',2,'p_right','150050076-150050096.py',703),
  ('expression -> expression PLUS expression','expression',3,'p_expression','150050076-150050096.py',713),
  ('expression -> expression MINUS expression','expression',3,'p_expression','150050076-150050096.py',714),
  ('expression -> expression ASTERISK expression','expression',3,'p_expression','150050076-150050096.py',715),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','150050076-150050096.py',716),
  ('expression -> var','expression',1,'p_expression2','150050076-150050096.py',759),
  ('expression -> NUMBERvar','expression',1,'p_expression2','150050076-150050096.py',760),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression3','150050076-150050096.py',767),
  ('NUMBERvar -> NUMBER','NUMBERvar',1,'p_numvar','150050076-150050096.py',773),
  ('NUMBERvar -> NUMBER2','NUMBERvar',1,'p_numvar2','150050076-150050096.py',783),
  ('var -> ASTERISK var','var',2,'p_var','150050076-150050096.py',793),
  ('var -> AMPERSAND var','var',2,'p_var','150050076-150050096.py',794),
  ('var -> NAME','var',1,'p_var','150050076-150050096.py',795),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','150050076-150050096.py',822),
  ('code_block -> if_stat','code_block',1,'p_code_block','150050076-150050096.py',834),
  ('code_block -> while_stat','code_block',1,'p_code_block','150050076-150050096.py',835),
  ('code_block -> assignment_statement','code_block',1,'p_code_block','150050076-150050096.py',836),
  ('code_block -> LBRACE function_content RBRACE','code_block',3,'p_code_block2','150050076-150050096.py',844),
  ('while_stat -> WHILE LPAREN b_expression RPAREN code_block','while_stat',5,'p_while','150050076-150050096.py',850),
  ('if_stat -> IF LPAREN b_expression RPAREN code_block','if_stat',5,'p_if1','150050076-150050096.py',859),
  ('if_stat -> IF LPAREN b_expression RPAREN code_block ELSE code_block','if_stat',7,'p_if2','150050076-150050096.py',869),
  ('b_expression -> expression sign1 expression','b_expression',3,'p_bool','150050076-150050096.py',880),
  ('b_expression -> b_expression sign2 b_expression','b_expression',3,'p_bool2','150050076-150050096.py',904),
  ('b_expression -> LPAREN b_expression RPAREN','b_expression',3,'p_bool_paren1','150050076-150050096.py',920),
  ('sign1 -> EQUALS','sign1',1,'p_sign','150050076-150050096.py',926),
  ('sign1 -> NOTEQUAL','sign1',1,'p_sign','150050076-150050096.py',927),
  ('sign1 -> GREATER','sign1',1,'p_sign','150050076-150050096.py',928),
  ('sign1 -> LESSER','sign1',1,'p_sign','150050076-150050096.py',929),
  ('sign1 -> GREATEREQ','sign1',1,'p_sign','150050076-150050096.py',930),
  ('sign1 -> LESSEREQ','sign1',1,'p_sign','150050076-150050096.py',931),
  ('sign2 -> LOGOR','sign2',1,'p_sign1','150050076-150050096.py',938),
  ('sign2 -> LOGAND','sign2',1,'p_sign1','150050076-150050096.py',939),
]
